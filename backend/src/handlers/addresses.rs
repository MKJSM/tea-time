...
pub async fn update_address(
    ...
    sqlx::query(
        r#"UPDATE addresses SET
           label = $1, recipient_name = $2, phone_number = $3, street_address = $4,
           city = $5, state = $6, postal_code = $7, latitude = $8, longitude = $9, is_default = $10,
           updated_at = NOW()
...
pub async fn delete_address(
    ...
    if address.is_default {
        // Find most recent address and make it default
        sqlx::query(
