        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-6 group">
              <img src={logo} alt="Tea Time" width="108" height="40" className="h-10 w-auto object-contain scale-110" />
            </Link>
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a key={idx} href="#" aria-label={label} className="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center text-gray-500 hover:bg-tea-50 hover:text-tea-700 transition-all focus:outline-none focus:ring-2 focus:ring-tea-500">
          ...
          <div>
            <h3 className="font-serif font-bold text-tea-900 mb-6 uppercase text-xs tracking-widest">Shop</h3>
          ...
          <div>
            <h3 className="font-serif font-bold text-tea-900 mb-6 uppercase text-xs tracking-widest">Help</h3>
            <ul className="space-y-4 text-sm text-gray-500 font-medium">
          ...
          <div>
            <h3 className="font-serif font-bold text-tea-900 mb-6 uppercase text-xs tracking-widest">Newsletter</h3>
            <p className="text-xs text-gray-500 mb-4 font-medium uppercase tracking-tighter" id="newsletter-description">Get offers and updates</p>
